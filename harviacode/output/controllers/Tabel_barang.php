...
class Tabel_barang extends MY_Controller
{
    ...
    public function index()
    {
      ...
      $data = array(
        'contain_view' => '{namamodule}/tabel_barang/tabel_barang_list',
    ...
    public function create(){
      $data = array(
        'contain_view' => '{namamodule}/tabel_barang/tabel_barang_form',
        ...
        'action'=>'{namamodule}/tabel_barang/create_action',
        'module'=>'{namamodule}',
        'titlePage'=>'tabel_barang',
        'controller'=>'tabel_barang'
       );
    ...
    public function edit($id){
      ...
      $data = array(
        'contain_view' => '{namamodule}/tabel_barang/tabel_barang_edit',
        'sidebar'=>'{namamodule}/sidebar',//Ini buat menu yang ditampilkan di module admin {DIKIRIM KE TEMPLATE}
        'css'=>'{namamodule}/crudassets/css',//Ini buat kirim css dari page nya  {DIKIRIM KE TEMPLATE}
        'script'=>'{namamodule}/crudassets/script',//ini buat javascript apa aja yang di load di page {DIKIRIM KE TEMPLATE}
        'action'=>'{namamodule}/tabel_barang/update_action',
        'dataedit'=>$dataedit,
        'module'=>'{namamodule}',
        'titlePage'=>'tabel_barang',
        'controller'=>'tabel_barang'
    ...
    public function create_action()
    {
		...
		'harga_barang' => $this->input->post('harga_barang',TRUE),
            ...
            redirect(site_url('{namamodule}/tabel_barang'));
        }
    }
