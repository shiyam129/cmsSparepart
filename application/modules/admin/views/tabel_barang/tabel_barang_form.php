  ...
  <div class="col-12">
    <div class="card">
	  ...
	  <div class="form-group">
            ...
            <input type="text" name="gambar_barang" class="form-control" placeholder="">
    </div>
	  <div class="form-group">
            <label>jenis_barang</label>
            <input type="text" name="jenis_barang" class="form-control" placeholder="">
    </div>
	  <div class="form-group">
            <label>harga_barang</label>
            <input type="text" name="harga_barang" class="form-control" placeholder="">
    </div>
